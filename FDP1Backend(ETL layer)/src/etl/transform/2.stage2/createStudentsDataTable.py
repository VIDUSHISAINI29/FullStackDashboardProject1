...
outputParquetLocationStudentsData = 'data/transformed/2.stage2/Students_Data.parquet'
...
connection.execute(f"COPY ({query}) TO '{outputParquetLocationStudentsData}' (FORMAT PARQUET)")
